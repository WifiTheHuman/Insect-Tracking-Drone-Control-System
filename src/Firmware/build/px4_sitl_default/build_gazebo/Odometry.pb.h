...
class Odometry : public ::google::protobuf::Message {
 public:
  ...
  inline int velocity_covariance_size() const;
  inline void clear_velocity_covariance();
  static const int kVelocityCovarianceFieldNumber = 7;
  inline float velocity_covariance(int index) const;
  inline void set_velocity_covariance(int index, float value);
  inline void add_velocity_covariance(float value);
  inline const ::google::protobuf::RepeatedField< float >&
