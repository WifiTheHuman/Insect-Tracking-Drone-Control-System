...
class Controller:
    ...
    def __init__(self):
        ...
        print("Collecting updates from processing center server...")
    ...
    def updateSp(self):
        ...
        print("time_sample: {}, latitude: {}, longitude: {}".format(
            time_sample, latitude, longitude))

        self.sp.pose.position.x = float(latitude)
        self.sp.pose.position.y = float(longitude)
